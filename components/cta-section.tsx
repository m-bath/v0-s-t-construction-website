    ...
    <section className="relative py-24 overflow-hidden bg-foreground">
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button size="lg" asChild className="text-base h-13 px-8 shadow-lg shadow-primary/40">
            <Link href="/quote">
              Get Your Free Quote
          ...
          <Button
            ...
            variant="outline"
            asChild
            className="text-base h-13 px-8 bg-transparent border-white/25 text-white hover:bg-white/10 hover:text-white"
          >
